...
public class ObjectFactory {
    ...
    private final static QName _ConvertirResponse_QNAME = new QName("http://polytechNancy.fr/", "convertirResponse");
    private final static QName _Convertir_QNAME = new QName("http://polytechNancy.fr/", "convertir");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://polytechNancy.fr/", name = "convertirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://polytechNancy.fr/", name = "convertir")
